...
#### 🟠 Major Issues
- **Story 1.1 (Setup) :** La story mentionne le setup Expo mais ne détaille pas l'installation des dépendances natives (souvent source de frictions).
...
2. **Setup Technique (Story 1.1) :** S'assurer de l'installation de `lottie-react-native` et des headers SQLite nécessaires lors du premier sprint.
